...
const abyssHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.keyword, color: base07, fontWeight: "regular" },
  { tag: t.controlKeyword, color: base0F, fontWeight: "regular" },
  { tag: t.moduleKeyword, color: base07, fontWeight: "regular" },
 ...
 */
const theme: Extension = [abyssTheme, syntaxHighlighting(abyssHighlightStyle)];
...
export { theme, abyssMergeStyles, applyMergeRevertStyles };
